...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "naveenkumarmarri-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/djangochef"
  #   chef.validation_client_name = "djangochef-validator"
  #   chef.validation_key_path = ".chef/djangochef-validator.pem"
  # end
end
